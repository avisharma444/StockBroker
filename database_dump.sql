...
INSERT INTO `portfolio` VALUES (1,1000,50000),(2,-500,75000),(3,-200,30000),(4,1200,60000),(5,500,25000),(6,-800,45000),(7,300,40000),(8,1500,90000),(9,-600,35000),(10,800,70000),(11,100,10000),(12,-400,55000),(22,0,0),(23,0,0),(24,0,0),(25,0,0),(26,0,0),(27,0,0),(28,0,0),(29,0,0);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_order_insert_after_buy` AFTER INSERT ON `transactions` FOR EACH ROW BEGIN
    -- Check if the transaction type is "buy"
    IF NEW.transaction_type = 'buy' THEN
        -- Update the stock table to decrement the quantity of current available stocks 
        UPDATE stock
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_user_registration` AFTER INSERT ON `user` FOR EACH ROW BEGIN
    INSERT INTO portfolio (user_id, total_loss_gain, total_value)
    VALUES (NEW.user_id, 0, 0); -- Initialize portfolio with default values
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
--
-- Dumping events for database 'zerodha'
--

--
-- Dumping routines for database 'zerodha'
--
...
-- Dump completed on 2024-07-01 19:14:12
